...
public class Dashboard_newpatient_search_Activity extends AppCompatActivity {
    ...
    View view;
    Snackbar snackbar;
    search_patient_listview_adapter adapter;
    List<PatientList> arraylist = new ArrayList<PatientList>();
    List<PatientList> newpatientlist;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if (AppStatus.getInstance(Dashboard_newpatient_search_Activity.this).isOnline()) {
    ...
    private void getPatientInformation() {
        deleteCache(Dashboard_newpatient_search_Activity.this);
        sharedPreferences = getSharedPreferences(MY_PREFERENCES, MainActivity.MODE_PRIVATE);
                    ...
                    public void onResponse(String s) {
                        ...
                        try {
                            ...
                            if (loginresult.length() > 0) {
                                ...
                                {
                                    PatientList wp = new PatientList(arrpatientid.get(i),arrpatientname.get(i),
                                            arrpatientmr.get(i),arrpatientmobilenumber.get(i),arrpatientimage.get(i));
                                    // Binds all strings into an array
                                    arraylist.add(wp);
                                }

                                adapter = new search_patient_listview_adapter(Dashboard_newpatient_search_Activity.this, arrpatientid, arrpatientname,arrpatientmr,arrpatientimage,arrpatientmobilenumber,arraylist);
        ...
        RequestQueue studentlist = Volley.newRequestQueue(Dashboard_newpatient_search_Activity.this);
